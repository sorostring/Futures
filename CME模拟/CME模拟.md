...
|成交价|谁主动action|Order Flow解释|进一步解释|
|---|---|---|---|
|Ask价成交|买家主动贴上去|Aggressive Buyer|Trade at Ask/Ask Volume|
|Bid价成交|卖家主动贴上去|Aggressive Seller|Trade at Bid/Bid volum|
...
这么设计的目的是什么？是为了市场的稳定？我举个极端的例子。交易进行中，我随便挂一个 `SELL 1.00$ @ 1手`的订单进来，如果采用我这个价格的话，我就轻松扰乱了市场，一瞬间就干跌停了。我就说我不小心输错了，监管机构都不能说我扰乱市场了。或者交易进行中，我随便挂出去一个 `BUY 10000.00$ @ 1手`的BUY的单子，如果成交价就按照我这个来，那就一下子把价格干涨停了。
...
还是举例字说明把，CME这个狗逼玩意。还是MESM6合约。

**opeation-1**
order is：
BUY @3手 @ 7590.75
position is (LAST = 7592.00)
Long 3 @ BUYS 3, SELLS 0 @ AVERAGE PX 7590.75 @ Unrealized PnL +18.75 @ Realized PnL 0.00

**opeation-2**
order is：
BUY @5手 @ 7591.50
position is (LAST = 7591.00)
Long 8 @ BUYS 8, SELLS 0 @ AVERAGE PX 7591.22 @ Unrealized PnL -8.75 @ Realized PnL 0.00

**opeation-3**
order is：
SELL @6手 @ 7593.50
position is (LAST = 7594.75)
Long 2 @ BUYS 8, SELLS 6 @ AVERAGE PX 7591.50 @ Unrealized PnL +30.00 @ Realized PnL 71.25
...
- 随时随地情况下，如果现在有未了结的position，也会产生 unrealized PnL，这个unrealized PnL，相当于是 f(last price)，成交价的函数，是随当前成交价而随时变化的。
